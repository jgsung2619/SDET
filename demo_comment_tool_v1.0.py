...
if __name__ == "__main__":
    ...
    # issue_search_convert = jira.search_issues("filter=49413", maxResults=1000) # 최초 계획 수립
    issue_search_convert = jira.search_issues("filter=49413 and (labels not in (demo:sp19, demo:skip:sp19, demo:delay:sp19) or labels is empty) ", maxResults=1000) # 계획 수립 지연
    print("### 관리대상 이니셔티브 ###")
